...
import '../sign_in_pro/sign_in_pro_widget.dart';
...
class SignUpProWidget extends StatefulWidget {
  const SignUpProWidget({Key key}) : super(key: key);

  @override
  _SignUpProWidgetState createState() => _SignUpProWidgetState();
}

class _SignUpProWidgetState extends State<SignUpProWidget> {
